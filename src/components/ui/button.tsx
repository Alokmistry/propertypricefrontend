  ...
  "inline-flex items-center justify-center gap-2 whitespace-nowrap rounded-lg text-sm font-medium font-body ring-offset-background transition-all duration-300 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2 disabled:pointer-events-none disabled:opacity-50 [&_svg]:pointer-events-none [&_svg]:size-4 [&_svg]:shrink-0",
  {
    variants: {
      variant: {
        ...
        gold: "bg-accent text-accent-foreground hover:opacity-90 shadow-gold hover:shadow-lg font-semibold",
        "gold-outline": "border-2 border-accent text-accent hover:bg-accent hover:text-accent-foreground font-semibold",
        premium: "bg-primary text-primary-foreground hover:opacity-95 shadow-elegant hover:shadow-elegant-xl font-semibold",
        "nav-outline": "border border-border bg-transparent text-foreground hover:bg-secondary hover:border-muted font-medium",
        "nav-solid": "bg-primary text-primary-foreground hover:bg-primary/90 font-medium",
      },
      size: {
